/*
Template Name: assets - Responsive Bootstrap 5 Admin Dashboard
Author: CoderThemes
    ...
    */
    ...
    App.prototype.init = function () {
        ...
        if (window.sessionStorage && bodyConfig && bodyConfig.hasOwnProperty('showRightSidebarOnPageLoad') && bodyConfig['showRightSidebarOnPageLoad']) {
            var alreadyVisited = sessionStorage.getItem("_assets_VISITED_");
            if (!alreadyVisited) {
                $.RightBar.toggleRightSideBar();
                sessionStorage.setItem("_assets_VISITED_", true);
            }
        }
