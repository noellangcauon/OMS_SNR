...
{
    public class ReprintWaybillOMController : Controller

    {
        ...
        public ReprintWaybillOMController(IConfiguration configuration, UserClass tokenInfo, IWebHostEnvironment webHostEnvironment, IDbAccess dbAccess)
        {
        ...
        public IActionResult ReprintWaybillOM()
        {
