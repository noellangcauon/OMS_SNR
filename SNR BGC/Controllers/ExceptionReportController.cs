...
namespace SNR_BGC.Controllers
{
...

    {
        ...
        public ExceptionReportController(IConfiguration configuration, UserClass tokenInfo, IWebHostEnvironment webHostEnvironment, IDbAccess dbAccess)
        {
        ...
        public JsonResult GetExceptionReport(string Type, DateTime? DateFrom, DateTime? DateTo)
        {
            if (Type == "null")
            {
                Type = null;
            ...
            items = _dbAccess.ExecuteSP2<ExceptionReportClass, dynamic>("GetExceptionReport", new { Type, DateFrom, DateTo });
